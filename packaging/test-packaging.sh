...
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'workflow_dispatch:'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'contents: read'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'group: apple-signing-smoke'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'runner: macos-15'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'runner: macos-15-intel'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'persist-credentials: false'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'ref: ${{ github.sha }}'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'test "$GITHUB_REF" = "$expected_ref"'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'merge-base --is-ancestor'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'signing-smoke-$SHORT_SHA'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'REQUIRE_APPLE_SIGNING:'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" './trusted/packaging/sign-and-notarize-darwin.sh'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" './trusted/packaging/generate-homebrew-cask.sh'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'cmp "$native_archive" "$RUNNER_TEMP/repeated.tar.gz"'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'brew audit --cask --arch all'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'brew install --cask'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'source=Notarized Developer ID'
assert_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'if: always()'
assert_not_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'pull_request_target:'
assert_not_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'actions/upload-artifact'
assert_not_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'contents: write'
assert_not_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'git push'
assert_not_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'gh release'
assert_not_contains "$repo/.github/workflows/apple-signing-smoke.yml" 'echo "$MACOS_'
